...
public enum EngineMessage {
    ...
    ACTION_TYPE_FAILED_VM_COULD_NOT_BE_SCHEDULED(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_VOLUME_ID_MAY_NOT_CONTAIN_SPECIAL_CHARS(ErrorType.BAD_PARAMETERS),
    ...
    VDS_CANNOT_MAINTENANCE_VM_HAS_NO_SUITABLE_HOST(ErrorType.CONFLICT),
    VDS_CANNOT_MAINTENANCE_VM_FILTERED_REASON_WITH_DETAIL(ErrorType.CONFLICT),
    VDS_CANNOT_MAINTENANCE_VM_FILTERED_REASON(ErrorType.CONFLICT),
    VDS_CANNOT_MAINTENANCE_VM_NO_HOSTS(ErrorType.CONFLICT),
    VDS_CANNOT_MAINTENANCE_VM_ALL_HOSTS_FILTERED_OUT(ErrorType.CONFLICT),
    VDS_CANNOT_MAINTENANCE_VM_INSUFFICIENT_COMBINED_RESOURCES(ErrorType.CONFLICT),
